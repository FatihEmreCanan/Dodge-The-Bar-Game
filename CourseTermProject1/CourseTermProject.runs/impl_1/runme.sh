...
HD_PWD='C:/Users/fcana/CourseTermProject1/CourseTermProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module_of_game.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_module_of_game.tcl -notrace
