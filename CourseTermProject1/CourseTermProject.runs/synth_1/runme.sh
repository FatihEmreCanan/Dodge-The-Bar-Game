...
HD_PWD='C:/Users/fcana/CourseTermProject1/CourseTermProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_module_of_game.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_module_of_game.tcl
